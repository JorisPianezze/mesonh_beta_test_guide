...
AROME GRIB files obtained with extractMF contain fields which aren't read by default by PREP_REAL_CASE. You could want to have this extra fields in your Meso-NH file. To get these fields, you have to use LDUMMY_REAL=T and fill a free formatted part at the end of PRE_REAL1.nam.
