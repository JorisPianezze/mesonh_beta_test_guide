...
The following namelists can be used in the :file:`PRE_NEST_PGD1.nam` file :
...
.. include:: namelists/nam_pgdn.rst
.. include:: namelists/nam_nest_pgd.rst
.. include:: namelists/nam_conf_nest.rst
