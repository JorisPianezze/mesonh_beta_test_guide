...
.. note::
   ...
   Un article en discussion dans *Geosci. Model Dev.* relate le travail de portage de Méso-NH sur GPU, il est disponible en ligne ici : `Escobar et al. (2024) <https://doi.org/10.5194/egusphere-2024-2879>`_.
