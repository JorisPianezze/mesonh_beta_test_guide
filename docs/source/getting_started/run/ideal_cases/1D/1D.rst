...
.. note::
   ...
   .. treeview::
      ...
      - :dir:`folder` |MNH_directory_extract_current|/MY_RUN/tutorials/ideal_cases/1D/
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/MY_RUN/tutorials/ideal_cases/1D/001_prep_ideal_case/
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/MY_RUN/tutorials/ideal_cases/1D/001_prep_ideal_case/
...
.. treeview::
   ...
   - :dir:`folder` |MNH_directory_extract_current|/MY_RUN/tutorials/1D/001_prep_ideal_case/
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/MY_RUN/tutorials/ideal_cases/1D/002_mesonh/
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/MY_RUN/tutorials/ideal_cases/1D/002_mesonh/
   ./run_mesonh.sh
...
.. code-block:: bash
   ...
   cd |MNH_directory_extract_current|/MY_RUN/tutorials/ideal_cases/1D/003_python/
   ./run_python.sh
...
.. tip::
   ...
   .. code-block:: bash
      ...
      |MNH_directory_extract_current|/MY_RUN/tutorials/ideal_cases/1D/003_python/
